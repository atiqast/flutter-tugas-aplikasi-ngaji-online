...
class _MateriState extends State<Materi> {
  List<Container> daftarMateri = new List();
  ...
  _buatlist() async {
    for (var i = 0; i < karakter.length; i++) {
      ...
      daftarMateri.add(new Container(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title: new Text("Materi Kajian",
            style: new TextStyle(
              color: Colors.white,
            )),
      ),
      body: new GridView.count(crossAxisCount: 2, children: daftarMateri),
    );
  }
}
